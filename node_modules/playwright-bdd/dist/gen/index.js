...
class TestFilesGenerator {
    ...
    async loadFeatures() {
        ...
        featurePaths.forEach((featurePath) => this.logger.log(`  ${(0, paths_1.relativeToCwd)(featurePath)}`));
    ...
    async loadSteps() {
        ...
        this.supportCodeLibrary = this.config.steps
            ? await (0, loadStepsOwn_1.loadStepsOwn)(environment.cwd, this.config.steps)
            : await (0, loadSteps_1.loadSteps)(this.runConfiguration, environment);
