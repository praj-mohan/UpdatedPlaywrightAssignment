...
const findStep_1 = require("../cucumber/findStep");
...
class StepInvoker {
    ...
    getStepDefinition(text) {
        const stepDefinition = (0, findStep_1.findStepDefinition)(this.world.options.supportCodeLibrary, text, this.world.testInfo.file);
        if (!stepDefinition) {
